...
namespace APIDemo.Data
{
    public sealed class Singleton
    {
        ...
        private Singleton()
        {
            ...
            Pelicula newPelicula = new Pelicula { Nombre = "El señor de los anillos", Anio = 2000, Director = "no se", Estrellas = 5, Genero = "fantasia" };
            Peliculas.put(newPelicula.Nombre, newPelicula);
